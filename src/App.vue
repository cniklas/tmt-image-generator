...
<template>
	<div id="navbar" class="fixed left-0 top-0 z-40 w-full" :class="{ 'opacity-30': state.isPainting }">
		...
		<a href="https://github.com/cniklas/tmt-image-generator" class="absolute right-4 top-5 h-6 w-6" rel="noopener">
			<span class="sr-only">GitHub repo</span>
			<svg aria-hidden="true" class="h-6 w-6 fill-current" viewBox="0 0 16 16">
				<path
					fill-rule="evenodd"
